...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full bg-gray-800 lg:hidden">
      <div className="flex flex-grow items-center justify-between lg:justify-end px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div className="lg:hidden">
          ...
          <button
            ...
            className="z-99999 block rounded-sm border border-strokedark bg-boxdark p-1.5 shadow-sm lg:hidden"
          >
