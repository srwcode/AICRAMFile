...
import { LayoutDashboard, Grid3x3, Building, FileChartColumn, TextSearch, ShieldCheck, Plus } from 'lucide-react';
import DropdownUser from '../../Header/member/DropdownUser';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-3">
              <li>
                <NavLink
                  to="/member/assessments/create"
                  className={`mb-6 group relative flex items-center gap-2.5 rounded-md py-3 px-4 font-medium duration-300 ease-in-out bg-white hover:bg-gray-300 text-gray-800`}
                >
                  <Plus />
                  New Assessment 
                </NavLink>
              ...
              <li>
                <NavLink
                  to="/member"
                  className={`group relative flex items-center gap-2.5 rounded-md py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-700 ${
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-md py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-700 ${
                    pathname.includes('member/assessments') && 'bg-gray-700'
                  }`}
                >
                  <TextSearch  />
                  Assessments
              ...
              <li>
                <NavLink
                  to="/member/results"
                  className={`group relative flex items-center gap-2.5 rounded-md py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-700 ${
                    pathname.includes('member/results') && 'bg-gray-700'
                  }`}
                >
                  <FileChartColumn  />
                  Results
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-md py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-700 ${
                    pathname.includes('member/organizations') && 'bg-gray-700'
                  }`}
                >
                  <Building  />
                  Organizations
              ...
              <li>
                <NavLink
                  to="/member/matrices"
                  className={`group relative flex items-center gap-2.5 rounded-md py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-gray-700 ${
                    pathname.includes('member/matrices') && 'bg-gray-700'
                  }`}
                >
                  <Grid3x3  />
                  Matrices
      ...
      <div className="hidden lg:block mt-auto px-6 py-5.5 border-t border-gray-700">
        <DropdownUser />
      </div>
    </aside>
  );
